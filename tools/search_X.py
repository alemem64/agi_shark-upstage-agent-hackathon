...
class search_X:
    def __init__(self):
        ...
        self.bearer_token = 'AAAAAAAAAAAAAAAAAAAAAGFd0QEAAAAAbdFccNgYAQ5vlUXjJ5n1KoCaxs8%3D2fyrr2dQ3ARKWEPpoWS9G8AxjfexD8Fzk1fGPmy8H99KoK7XR1'
        self.client = None
